...
class Snake16Ultimate:
    def __init__(self):
        ...
        # Шрифты
        self.font_s = pygame.font.SysFont("sans-serif", 45, bold=True)
        self.font_m = pygame.font.SysFont("sans-serif", 70, bold=True)
        self.font_l = pygame.font.SysFont("sans-serif", 130, bold=True)
    ...
    def draw_entities(self):
        ...
        ar = self.CELL//2 - 5
        pygame.draw.circle(self.screen, (150, 0, 0), (ax+3, ay+3), ar) # Тень
        pygame.draw.circle(self.screen, (220, 20, 20), (ax, ay), ar) # Тело
        pygame.draw.circle(self.screen, (255, 120, 120), (ax-4, ay-4), ar//2) # Блик
        pygame.draw.rect(self.screen, (0, 120, 0), (ax-2, ay-ar-8, 4, 10)) # Черенок
